  ...
  <div class="food" ref="food" v-show="showFlag">
    <div class="food-content">
      ...
      <div class="rating">
        ...
        <ratingselect v-on:ratingTypeSelect="ratingTypeSelect" v-on:contentToggle="contentToggle" :select-type="selectType" :only-content="onlyContent" :desc="desc" :ratings="food.ratings"></ratingselect>
...
export default {
  name: 'food',
  components: {Ratingselect, Ratings, Split, Cartcontrol},
  data: function () {
    return {
      showFlag: false,
      selectType: ALL,
